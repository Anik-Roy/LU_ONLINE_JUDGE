...
@section('contant')
    <div class="container-fluid">
        <div class="row">
            @if (session('message') == 'Post is deleted successfully.')
                <script>
                    iziToast.success({
                        title: 'OK',
                ...
                <div>
                    <form action="{{url('post/delete/'.$post->id)}}" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <br/>
                            @csrf
                            <input style="margin-bottom:10px;" class="btn btn-danger btn-block" type="submit" name="Submit" value="Delete Post">
                        </fieldset>
                    </form>
                </div>
